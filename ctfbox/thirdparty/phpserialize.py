...
__modified__ = 'Longlone <toloveu29@gmail.com>'
__version__ = '1.3'
__all__ = ['phpobject', 'convert_member_dict', 'dict_to_list', 'dict_to_tuple',
           'serialize', 'unserialize', 'serialize_to_file', 'unserialize_from_file']
